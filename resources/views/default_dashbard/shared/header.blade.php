          ...
          <!-- <div class="c-avatar"><img class="c-avatar-img" src="{{ url('/assets/img/avatars/6.jpg') }}" style="width: 80px;height: 80px; padding: 10px; margin: 0px; " alt="user@email.com"></div> -->
            ...
            <div class="dropdown-menu dropdown-menu-right pt-0">
              ...
              <div class="dropdown-divider"></div><a class="dropdown-item" href="#">
                ...
                <!-- Change Profile</a><a class="dropdown-item" href="/slide/"> -->
                ...
                <!-- <svg class="c-icon mr-2">
                  <use xlink:href="{{ url('/icons/sprites/free.svg#cil-user') }}"></use>
                </svg> Profile</a><a class="dropdown-item" href="/slide/create">
                <form action="{{ url('/slide/create') }}" method="get"> @csrf <button type="submit" class="btn btn-ghost-dark btn-block">Change Profile</button></form></a> -->
