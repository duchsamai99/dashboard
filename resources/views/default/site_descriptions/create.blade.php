                ...
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="sitName" id="sitName" class="form-control w3-input">
                    </div>   
                  </div>
                  <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                      <span class="text-secondary">Copy Right:</span>
                      <input type="text" name="sitCopyRight" id="sitCopyRight" class="form-control w3-input">
                    </div>   
                  </div>
                  <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                      <span class="text-secondary">ReciverMail:</span>
                      <input type="text" name="sitReceiverMail" id="sitReceiverMail" class="form-control w3-input">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="sitPhoneNumber" id="sitPhoneNumber" class="form-control w3-input">
                    </div>   
                  </div>
                </div>
