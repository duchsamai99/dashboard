...
<div class="container-fluid">
  <div class="fade-in">
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h4>Admin menues</h4></div>
            <div class="card-body">
                <div class="row mb-3 ml-1">
                  <a class="btn btn-lg btn-info" href="{{ route('menu.create') }}">Add new site menu</a>
                </div>
				...
				<tbody>
                    ...
                    <!-- delete modal -->
                    <form action="{{ route('menu.delete', ['id' => $menuel['id']]) }}" method="POST" enctype="multiple/form-data">
						{{ csrf_field() }}
						{{ method_field('DELETE') }}  
						...
						<tr>
                			...
                			@if (array_key_exists('elements', $menuel) && count($menuel['elements']) > 0)
								...
								<tr>
									...
									<td>
										<a class="btn btn-warning text-white" href="{{ route('menu.edit', ['id' => $item['id']]) }}">Edit</a>
									</td>
									<td>
