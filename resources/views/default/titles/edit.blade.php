  ...
  <div class="container-fluid">
    <div class="fade-in">
      <div class="row">
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header"><h4>Edit Title</h4></div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="titTitle" id="titTitle" class="form-control" placeholder="Title" value = "{{$title->titTitle}}" required>
                      </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" type="text" id="titDescription" name="titDescription">{!!$title->titDescription!!}</textarea>
                      </div>   
                    </div>
    ...
    $.ajax({
      ...
      success:function(response){
        ...
        if(response == true){
          ...
          location.replace('/titles/{{ $title->titAutoID }}/edit');
