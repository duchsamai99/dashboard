    ...
    */
    ...
    { 
        ...
        $this->beginDropdown('admin', 'Settings', 'cil-calculator');
            ...
            $this->insertLink('admin', 'Admin menu', '/menu/element'   , 'cil-align-center');
            $this->insertLink('admin', 'Site Description' , '/site-descriptions'    , 'cil-sitemap'); 
            $this->insertLink('admin', 'Site menu', '/site/menu'   , 'cil-align-center');
            $this->insertLink('admin', 'Social' , '/socials'    , 'cil-sitemap'); 
            $this->insertLink('admin', 'Title', '/titles'   , 'cil-align-center'); 
        $this->endDropdown();   
        $this->insertLink('admin', 'Slide'     , '/slides'   , 'cil-calculator');
        ...
        //     // $this->insertLink('admin', 'Siderbar Menu',           '/sidebar/menu');
        ...
        // $this->insertLink('admin', 'Siderbar Menu',           '/sidebar/menu');
        // $this->insertLink('admin', 'Slide',                   'slide');
        // $this->insertLink('guest', 'Login', '/login', 'cil-account-logout');
        // $this->insertLink('guest', 'Register', '/register', 'cil-account-logout');
